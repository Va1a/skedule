...
class AddShiftForm(FlaskForm):
	...
	employees = StringField('Assign Employees:', validators=[Optional(), Length(0, 512), Regexp(r'^[1-9]\d(?:, {0,1}[1-9]\d)*$', message='Input must be a comma seperated list of employee IDs.')])
